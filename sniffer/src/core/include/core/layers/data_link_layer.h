...
#ifndef SNIFFER_SRC_CORE_LAYERS_DATA_LINK_LAYER_H_
#define SNIFFER_SRC_CORE_LAYERS_DATA_LINK_LAYER_H_
...
class DataLinkLayer : public Layer {
 public:
  DataLinkLayer(const SerializationMgr& serializer,
...
#endif  // SNIFFER_SRC_CORE_LAYERS_DATA_LINK_LAYER_H_
